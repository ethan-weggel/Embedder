...
# # Define the list of target words to display
# target_words = {"wheat", "flour", "food", "soil", "farming", "crop", "grain"}  # Replace with your specific words
...
#         file_path = os.path.join(folder_path, filename)
#         word, embedding_array = parse_custom_csv(file_path)
#         if word in target_words and embedding_array.size > 0:
#             words_and_embeddings.append((word, embedding_array))
#         elif word:
#             print(f"Word '{word}' not in target list. Skipping.")
